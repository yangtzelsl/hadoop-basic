 ...
 * E:\data
 */
public class FlinkSQLKafka2LocalFS {
    ...
    private static final String LOCAL_FS_SINK_SQL = "CREATE TABLE user_behavior_filesystem (\n" +
            "  user_id BIGINT,\n" +
            "  item_id BIGINT \n" +
    ...
    private static final String PROCESS_SQL = "insert into user_behavior_filesystem select user_id, item_id from user_behavior";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("+++++++++++++++++++++++++++++++++++++++++++");
        System.out.println(LOCAL_FS_SINK_SQL);

        streamTableEnv.executeSql(KAFKA_SOURCE_SQL);

        streamTableEnv.executeSql(LOCAL_FS_SINK_SQL);

        streamTableEnv.executeSql(PROCESS_SQL);

        streamTableEnv.execute("FlinkSQLKafka2LocalFS");
    }
}
